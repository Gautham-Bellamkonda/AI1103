...
\section*{Solution}
Let $H \in \{ 0, 1\}$ denote the random variable of the patient having a heart attack, $A \in \{ 0, 1\} $ denote the random variable of the patient taking a meditation and yoga course, or the patient taking the drug.\\
Given that,
\begin{align*}
\text{Pr}(H=1) &= 0.4 \\
...
\begin{align*}
&\text{Pr}(A=0|H=1) \\
&= \dfrac{\text{Pr}(H=1|A=0)\,\text{Pr}(A=0)}{\sum_{i=0} ^ 1 \text{Pr}(H=1|A=i)\,\text{Pr}(A=i)} \\
\end{align*}
